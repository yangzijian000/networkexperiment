...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.routername = QtWidgets.QLineEdit(self.centralwidget)
        self.routername.setGeometry(QtCore.QRect(130, 36, 201, 31))
        self.routername.setObjectName("routername")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(10, 77, 111, 20))
        self.label_3.setObjectName("label_3")
        self.nbnoodinf = QtWidgets.QLineEdit(self.centralwidget)
        self.nbnoodinf.setGeometry(QtCore.QRect(130, 76, 201, 31))
        self.nbnoodinf.setObjectName("nbnoodinf")
        ...
        self.addrouterButton.setGeometry(QtCore.QRect(140, 150, 99, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "输入路由器信息:"))
        self.label_2.setText(_translate("MainWindow", "路由器名称:"))
        self.label_3.setText(_translate("MainWindow", "邻居节点及距离："))
        self.label_4.setText(_translate("MainWindow", "路由器添加日志："))
